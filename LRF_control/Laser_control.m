...
xlabel('\fontsize{14} \fontname{Times New Roman} (k)');
...
title('\fontsize{14} \fontname{Times New Roman} Velocity trajectory');
xlabel('\fontsize{14} \fontname{Times New Roman} (k)');
ylabel('\fontsize{14} \fontname{Times New Roman} Velocity(speed)');
legend('vl','vr');

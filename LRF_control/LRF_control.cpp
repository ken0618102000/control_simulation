...
BEGIN_MESSAGE_MAP(CLRF_controlApp, CWinApp)
...
CLRF_controlApp::CLRF_controlApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CLRF_controlApp 物件

CLRF_controlApp theApp;


// CLRF_controlApp 初始設定

BOOL CLRF_controlApp::InitInstance()
{
